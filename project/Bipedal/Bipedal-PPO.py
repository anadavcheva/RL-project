...
class AGENT:
    ...
    def choose_action(self, state, episode):
        if episode % 100 != 0:
            action = self.actor_.predict([state.reshape(1, -1), DUMMY_VALUE, DUMMY_ACTION])[0] + np.random.normal(0,
                                                                                                                  NOISE,
                                                                                                                  4)
    ...
    def sample_Critic(self):
        ...
        #
        h2 = Dense(64, activation='relu', kernel_regularizer=self.k_r)
    ...
    for i in range(EPISODES):
        ...
        while True:
            ...
            if counter >= BATCH:
                ...
                # Train on batches #
                train_time, avg_actor_loss, avg_critic_loss, message = agent.TRAIN(obs, action, pred, returns,
                                                                                   advantage, \
